...
Step 1 discovers which repositories the index contains. Every call after it must say which of those
...
silently. If you cannot tell which repository the user means, stop and ask. Report
...
**context** gives a 360-degree view of a symbol.
...
Once the index contains more than one repository, you must supply `repo`.
With a single repository, you can omit it.
